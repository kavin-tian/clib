...
//        this.setFpsReduction(1.0F / 0.0);
    ...
    public void addFrameListener(FrameListener listener, float scale, @Nullable GlDrawer drawerParam, boolean applyFpsReduction) {
    ...
    private static class FrameListenerAndParams {
        ...
        public FrameListenerAndParams(FrameListener listener, float scale, GlDrawer drawer, boolean applyFpsReduction) {
