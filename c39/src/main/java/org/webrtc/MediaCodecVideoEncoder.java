...
//                        this.mediaCodec.configure(format, (Surface)null, (MediaCrypto)null, 1);
                        this.mediaCodec.configure(format, (Surface) null, (MediaCrypto) null, MediaCodec.CONFIGURE_FLAG_ENCODE);
                        if (useSurface) {
    ...
    void release() {
        ...
        class _CaughtException {
            Exception e;

            _CaughtException/* $FF was: 1CaughtException*/() {
            }
        }

        final _CaughtException caughtException = new _CaughtException();
