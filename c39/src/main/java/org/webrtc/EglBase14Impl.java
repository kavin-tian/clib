...
class EglBase14Impl implements EglBase14 {
    ...
    public static boolean isEGL14Supported() {
        Logging.d("EglBase14Impl", "SDK version: " + CURRENT_SDK_VERSION + ". isEGL14Supported: " + (CURRENT_SDK_VERSION >= 18));
    ...
    public static class Context implements EglBase14.Context {
        ...
        public long getNativeEglContext() {
            return EglBase14Impl.CURRENT_SDK_VERSION >= 21 ? this.egl14Context.getNativeHandle() : (long)this.egl14Context.getHandle();
        }
