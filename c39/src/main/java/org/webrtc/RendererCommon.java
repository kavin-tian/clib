...
public class RendererCommon {
    ...
    public static class VideoLayoutMeasure {
        ...
        public VideoLayoutMeasure() {
            this.visibleFractionMatchOrientation = RendererCommon.convertScalingTypeToVisibleFraction(ScalingType.SCALE_ASPECT_BALANCED);
            this.visibleFractionMismatchOrientation = RendererCommon.convertScalingTypeToVisibleFraction(ScalingType.SCALE_ASPECT_BALANCED);
        }
        ...
        public Point measure(int widthSpec, int heightSpec, int frameWidth, int frameHeight) {
            int maxWidth = View.getDefaultSize(2147483647, widthSpec);
            int maxHeight = View.getDefaultSize(2147483647, heightSpec);
