...
public interface EglBase {
    ...
    static EglBase create(@Nullable Context sharedContext, int[] configAttributes) {
        ...
        } else if (sharedContext instanceof org.webrtc.EglBase14.Context) {
            return createEgl14((org.webrtc.EglBase14.Context)sharedContext, configAttributes);
        } else if (sharedContext instanceof org.webrtc.EglBase10.Context) {
            return createEgl10((org.webrtc.EglBase10.Context)sharedContext, configAttributes);
        } else {
    ...
    static EglBase10 createEgl10(org.webrtc.EglBase10.Context sharedContext, int[] configAttributes) {
    ...
    static EglBase14 createEgl14(org.webrtc.EglBase14.Context sharedContext, int[] configAttributes) {
