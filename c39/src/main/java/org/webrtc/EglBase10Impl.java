...
class EglBase10Impl implements EglBase10 {
    ...
    public void createSurface(Surface surface) {
        class _FakeSurfaceHolder implements SurfaceHolder {
            private final Surface surface;

            _FakeSurfaceHolder/* $FF was: 1FakeSurfaceHolder*/(Surface surface) {
        ...
        this.createSurfaceInternal(new _FakeSurfaceHolder(surface));
    }
