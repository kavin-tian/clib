...
public class YuvConverter {
    ...
    public I420Buffer convert(TextureBuffer inputTextureBuffer) {
        ...
        TextureBuffer preparedBuffer = (TextureBuffer)this.videoFrameDrawer.prepareBufferForViewportSize(inputTextureBuffer, inputTextureBuffer.getWidth(), inputTextureBuffer.getHeight());
