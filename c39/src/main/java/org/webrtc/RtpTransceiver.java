...
public class RtpTransceiver {
    ...
    private static native MediaType nativeGetMediaType(long var0);
    ...
    public static final class RtpTransceiverInit {
        ...
        public RtpTransceiverInit(RtpTransceiverDirection direction, List<String> streamIds, List<Encoding> sendEncodings) {
