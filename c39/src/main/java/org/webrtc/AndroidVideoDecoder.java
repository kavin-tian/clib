...
class AndroidVideoDecoder implements VideoDecoder, VideoSink {
    ...
    AndroidVideoDecoder(MediaCodecWrapperFactory mediaCodecWrapperFactory, String codecName, VideoCodecType codecType, int colorFormat, @Nullable Context sharedContext) {
