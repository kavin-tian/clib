...
public class SurfaceEglRenderer extends EglRenderer implements Callback {
    ...
    public void init(Context sharedContext, RendererEvents rendererEvents, int[] configAttributes, GlDrawer drawer) {
    ...
    public void init(Context sharedContext, int[] configAttributes, GlDrawer drawer) {
        this.init(sharedContext, (RendererEvents)null, configAttributes, drawer);
    }
