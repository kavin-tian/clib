...
public class WebRtcAudioTrack {
    ...
    WebRtcAudioTrack(Context context, AudioManager audioManager) {
        this(context, audioManager, (AudioTrackErrorCallback) null, (AudioTrackStateCallback) null);
    }

    WebRtcAudioTrack(Context context, AudioManager audioManager, @Nullable AudioTrackErrorCallback errorCallback, @Nullable AudioTrackStateCallback stateCallback) {
        ...
        public void run() {
            ...
            for (int sizeInBytes = WebRtcAudioTrack.this.byteBuffer.capacity(); this.keepAlive; WebRtcAudioTrack.this.byteBuffer.rewind()) {
                ...
                if (bytesWritten != sizeInBytes) {
                    ...
                    WebRtcAudioTrack.mWebRtcAudioTrackCallback.onWebRtcAudioTracking(WebRtcAudioTrack.this.byteBuffer, bytesWritten, WebRtcAudioTrack.this.speakerMute);
                }
            }
    ...
    public static void setWebRtcAudioTrackCallback(WebRtcAudioTrackCallback webRtcAudioTrackCallback) {
        WebRtcAudioTrack.mWebRtcAudioTrackCallback = webRtcAudioTrackCallback;
    }

    public static abstract class WebRtcAudioTrackCallback {

        public abstract void onWebRtcAudioTrackInit(int audioFormat, int sampleRate, int channels,
                                                    int bitsPerSample, int buffersPerSecond, int bufferSize);

        public abstract void onWebRtcAudioTrackStart();

        public abstract void onWebRtcAudioTracking(ByteBuffer byteBuffer, int bytesWrite, boolean speakerMute);
