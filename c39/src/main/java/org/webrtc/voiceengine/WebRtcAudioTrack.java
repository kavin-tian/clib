...
public class WebRtcAudioTrack {
    ...
    private static AudioTrack createAudioTrackOnLollipopOrHigher(int sampleRateInHz, int channelConfig, int bufferSizeInBytes) {
        ...
        return new AudioTrack((new Builder()).setUsage(usageAttribute).setContentType(1).build(), (new android.media.AudioFormat.Builder()).setEncoding(2).setSampleRate(sampleRateInHz).setChannelMask(channelConfig).build(), bufferSizeInBytes, 1, 0);
    }
