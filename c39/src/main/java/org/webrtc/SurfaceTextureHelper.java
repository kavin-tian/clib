...
public class SurfaceTextureHelper {
    ...
    public static SurfaceTextureHelper create(final String threadName, final Context sharedContext, final boolean alignTimestamps, final YuvConverter yuvConverter, final FrameRefMonitor frameRefMonitor) {
    ...
    private SurfaceTextureHelper(Context sharedContext, Handler handler, boolean alignTimestamps, YuvConverter yuvConverter, FrameRefMonitor frameRefMonitor) {
