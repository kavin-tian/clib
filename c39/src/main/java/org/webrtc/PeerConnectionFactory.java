...
public class PeerConnectionFactory {
    ...
    @Nullable
    PeerConnection createPeerConnectionInternal(RTCConfiguration rtcConfig, MediaConstraints constraints, Observer observer, SSLCertificateVerifier sslCertificateVerifier) {
    ...
    @Nullable
    public PeerConnection createPeerConnection(List<IceServer> iceServers, Observer observer) {
        RTCConfiguration rtcConfig = new RTCConfiguration(iceServers);
    ...
    @Nullable
    public PeerConnection createPeerConnection(RTCConfiguration rtcConfig, PeerConnectionDependencies dependencies) {
    ...
    private static native long nativeCreatePeerConnection(long var0, RTCConfiguration var2, MediaConstraints var3, long var4, SSLCertificateVerifier var6);
    ...
    public static class InitializationOptions {
        ...
        private InitializationOptions(Context applicationContext, String fieldTrials, boolean enableInternalTracer, NativeLibraryLoader nativeLibraryLoader, String nativeLibraryName, @Nullable Loggable loggable, @Nullable Severity loggableSeverity) {
